...
const CodeSection = () => {
  ...
  return (
    <div className="relative px-4 py-[96px] md:px-[275px] md:py-[250px] flex flex-col gap-8 md:gap-0 justify-center items-center text-center">
      <div className="absolute inset-0  bg-[url('/Gradient.svg')] w-full -z-10" />
